...
<style type="text/css">
  ...
  <body>
<h1 style="text-align: center;">Opportunity</h1>
<div style="font-size: 10pt;">
	<c:choose>
		...
		<c:otherwise>
			...
			<a href="<c:url value='/jsps/login_user/login_user_menu.jsp'/>" target="body">CRUD Login User</a> |&nbsp;&nbsp;
			<a href="<c:url value='/jsps/tutoring_service/tutoring_service_menu.jsp'/>" target="body">CRUD Tutoring Service</a> |&nbsp;&nbsp;
			...
			<a href="<c:url value='/jsps/health_resources/health_resources_menu.jsp'/>" target="body">CRUD Health Resources</a> |&nbsp;&nbsp;
			<a href="<c:url value='/jsps/scholarship/scholarship_menu.jsp'/>" target="body">CRUD Scholarship</a> |&nbsp;&nbsp;			
		</c:otherwise>
	</c:choose>
