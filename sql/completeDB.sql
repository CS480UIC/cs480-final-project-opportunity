...
CREATE TABLE `academic_resource` (
  ...
  KEY `user_id` (`user_id`),
  KEY `AcadSubjectIndex` (`acad_subject`),
...
CREATE TABLE `health_resource` (
  ...
  KEY `user_id` (`user_id`),
  KEY `HealthTypeIndex` (`health_type`),
...
CREATE TABLE `scholarship` (
  ...
  KEY `user_id` (`user_id`),
  KEY `ScholarIndex` (`reward_amount`),
...
-- Dump completed on 2021-11-10 16:27:24
